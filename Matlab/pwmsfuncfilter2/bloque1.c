 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Jul 09 19:28:26 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME bloque1
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
{
    real_T *dist1 = (real_T *) ssGetOutputPortRealSignal(S, 0);
    const real_T *xD = ssGetDiscStates(S);

    bloque1_Outputs_wrapper(dist1, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    bloque1_Update_wrapper(dist1, xD);
