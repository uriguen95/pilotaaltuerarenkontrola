###########################################################################
## Makefile generated for Simulink model 'pwmsfunc'. 
## 
## Makefile     : pwmsfunc.mk
## Generated on : Tue Jul 30 09:22:26 2019
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pwmsfunc.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/Ekain/Desktop/pwmsfuncfilter2
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = pwmsfunc_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pwmsfunc.elf
...
DEFINES_STANDARD = -DMODEL=pwmsfunc -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : D:/Datos/Descargas/Dropbox/Dropbox/euriguen/pwmsfuncfilter2/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : D:/Datos/Descargas/Dropbox/Dropbox/euriguen/pwmsfuncfilter2/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : D:/Datos/Descargas/Dropbox/Dropbox/euriguen/pwmsfuncfilter2/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/pwmsfunc_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/pwmsfunc_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/pwmsfunc_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
