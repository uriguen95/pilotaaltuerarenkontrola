###########################################################################
## Makefile generated for Simulink model 'LevitatePingPongEkain'. 
## 
## Makefile     : LevitatePingPongEkain.mk
## Generated on : Tue Jul 09 18:43:27 2019
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/LevitatePingPongEkain.elf
...
PRODUCT_NAME              = LevitatePingPongEkain
MAKEFILE                  = LevitatePingPongEkain.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/Datos/Descargas/Dropbox/Dropbox/euriguen/pwmblokemodeloa
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = LevitatePingPongEkain_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LevitatePingPongEkain.elf
...
DEFINES_STANDARD = -DMODEL=LevitatePingPongEkain -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/LevitatePingPongEkain_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/LevitatePingPongEkain_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/LevitatePingPongEkain_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
