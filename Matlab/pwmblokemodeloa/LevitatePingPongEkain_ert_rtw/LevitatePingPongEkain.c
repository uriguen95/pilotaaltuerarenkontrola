...
void LevitatePingPongEkain_initialize(void)
{
  ...
  LevitatePingPongEkain_M->Timing.stepSize0 = 0.006;

  /* External mode info */
  LevitatePingPongEkain_M->Sizes.checksums[0] = (2592264293U);
  LevitatePingPongEkain_M->Sizes.checksums[1] = (1901765658U);
  LevitatePingPongEkain_M->Sizes.checksums[2] = (769509924U);
  LevitatePingPongEkain_M->Sizes.checksums[3] = (4192684277U);
